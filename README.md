# ![nf-core/phylophoenix](docs/images/nf-core-phylophoenix_logo_light.png#gh-light-mode-only) ![nf-core/phylophoenix](docs/images/nf-core-phylophoenix_logo_dark.png#gh-dark-mode-only)
...
[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23phylophoenix-4A154B?labelColor=000000&logo=slack)](https://nfcore.slack.com/channels/phylophoenix)[![Follow on Twitter](http://img.shields.io/badge/twitter-%40nf__core-1DA1F2?labelColor=000000&logo=twitter)](https://twitter.com/nf_core)[![Watch on YouTube](http://img.shields.io/badge/youtube-nf--core-FF0000?labelColor=000000&logo=youtube)](https://www.youtube.com/c/nf-core)

## Introduction

<!-- TODO nf-core: Write a 1-2 sentence summary of what data the pipeline is for and what it does -->

**nf-core/phylophoenix** is a bioinformatics best-practice analysis pipeline for Pipeline for relatedness determination using PHoeNIx output..
...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```bash
   nextflow run nf-core/phylophoenix -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run nf-core/phylophoenix --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```

## Documentation

The nf-core/phylophoenix pipeline comes with documentation about the pipeline [usage](https://nf-co.re/phylophoenix/usage), [parameters](https://nf-co.re/phylophoenix/parameters) and [output](https://nf-co.re/phylophoenix/output).
